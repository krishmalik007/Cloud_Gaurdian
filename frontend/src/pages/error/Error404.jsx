  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center select-none">
      <div className="flex flex-col items-center max-w-md gap-4">
        <HiOutlineExclamationCircle className="w-16 h-16 text-orange animate-pulse" />
        <div className="flex flex-col gap-1">
          <h1 className="text-4xl font-extrabold text-text-primary tracking-tight">404</h1>
          <h2 className="text-lg font-bold text-text-secondary">Telemetry Node Not Found</h2>
          <p className="text-xs text-text-muted">
            The requested security dashboard page or resource does not exist or has been archived.
          </p>
        </div>
